...
window.title("Armored Virus by Abhinav and Chiranjeev")
...
def mainFrameNj():
    ...
    photoi = PhotoImage(file = "Asset\\0.png").subsample(3,3)
    photog = PhotoImage(file = "Asset\\0 a.png").subsample(3,3)
    photoScan = PhotoImage(file = "Asset\\scan l.png").subsample(4,4)
    junkFileRemoverImg = PhotoImage( file = "Asset\\junk file remover.png").subsample(4,4)
    quickScanImg = PhotoImage(file ="Asset\\quick scan.png").subsample(4,4)
    ramBoosterImg = PhotoImage(file = "Asset\\ram booster.png").subsample(4,4)

    buleAnimationPlus0 = PhotoImage( file = "Asset\\blue ani\\0.png").subsample(21,21)
    buleAnimationPlus1 = PhotoImage( file = "Asset\\blue ani\\1.png").subsample(21,21)
    buleAnimationPlus2 = PhotoImage( file = "Asset\\blue ani\\2.png").subsample(21,21)
    buleAnimationPlus3 = PhotoImage( file = "Asset\\blue ani\\3.png").subsample(21,21)
    buleAnimationPlus4 = PhotoImage( file = "Asset\\blue ani\\4.png").subsample(21,21)
    buleAnimationPlus5 = PhotoImage( file = "Asset\\blue ani\\5.png").subsample(21,21)
    ...
    bitLinkMainLabel = Label(nj, text = "Armored Antivirus", font = "Times 30 bold")
...
def quickScanFrame():
    ...
    with open("virusHash copy.unibit", "r") as nr:
        samB = nr.readlines()
        nr.close()
    ...
    backButtonImg = PhotoImage(file = "Asset\\back button.png").subsample(4,4)
    prog0 = PhotoImage( file = "Asset\\progress bar\\0.png").subsample(1,3)
    prog1 = PhotoImage( file = "Asset\\progress bar\\1.png").subsample(1,3)
    prog2 = PhotoImage( file = "Asset\\progress bar\\2.png").subsample(1,3)
    prog3 = PhotoImage( file = "Asset\\progress bar\\3.png").subsample(1,3)
    prog4 = PhotoImage( file = "Asset\\progress bar\\4.png").subsample(1,3)
    prog5 = PhotoImage( file = "Asset\\progress bar\\5.png").subsample(1,3)
